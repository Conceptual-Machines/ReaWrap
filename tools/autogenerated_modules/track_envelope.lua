...
function TrackEnvelope:evaluate(time, samplerate, samples_requested)
    return r.Envelope_Evaluate(self.pointer, time, samplerate, samples_requested)
end
...
function TrackEnvelope:get_parent_take()
    local result = r.Envelope_GetParentTake(self.pointer)
...
function TrackEnvelope:get_parent_track()
    local result = r.Envelope_GetParentTrack(self.pointer)
...
function TrackEnvelope:get_envelope_name()
    return r.GetEnvelopeName(self.pointer)
end
...
function TrackEnvelope:get_envelope_point(pt_idx)
    return r.GetEnvelopePoint(self.pointer, pt_idx)
end
...
function TrackEnvelope:get_envelope_point_ex(autoitem_idx, pt_idx)
    return r.GetEnvelopePointEx(self.pointer, autoitem_idx, pt_idx)
end
...
function TrackEnvelope:get_envelope_state_chunk(str, is_undo)
    return r.GetEnvelopeStateChunk(self.pointer, str, is_undo)
end
...
function TrackEnvelope:get_set_automation_item_info_string(autoitem_idx, desc, valuestr_need_big, is_set)
    return r.GetSetAutomationItemInfo_String(self.pointer, autoitem_idx, desc, valuestr_need_big, is_set)
end
...
function TrackEnvelope:get_set_envelope_info_string(parm_name, string_need_big, set_new_value)
    return r.GetSetEnvelopeInfo_String(self.pointer, parm_name, string_need_big, set_new_value)
end
