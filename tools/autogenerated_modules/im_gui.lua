...
function ImGui:drag_double4(ctx, label, v1, v2, v3, v4, number, number, number, string, integer)
	...
	local string = string or nil
	local integer = integer or nil
	local ret_val, v1, v2, v3, v4 =
		r.ImGui_DragDouble4(ctx, label, v1, v2, v3, v4, number, number, number, string, integer)
	if ret_val then
		return v1, v2, v3, v4
	else
		return nil
...
function ImGui:drag_float_range2(
	...
	local string = string or nil
	local integer = integer or nil
	local ret_val, v_current_min, v_current_max = r.ImGui_DragFloatRange2(
		ctx,
		label,
		v_current_min,
		v_current_max,
...
function ImGui:drag_int4(ctx, label, v1, v2, v3, v4, number, integer, integer, string, integer)
	...
	local string = string or nil
	local ret_val, v1, v2, v3, v4 =
		r.ImGui_DragInt4(ctx, label, v1, v2, v3, v4, number, integer, integer, string, integer)
	if ret_val then
		return v1, v2, v3, v4
	else
		return nil
...
function ImGui:drag_int_range2(
	...
	local integer = integer or nil
	local string = string or nil
	local ret_val, v_current_min, v_current_max = r.ImGui_DragIntRange2(
		ctx,
		label,
		v_current_min,
		v_current_max,
...
-- @param thickness number
-- @param integer num_segmentsIn Optional
function ImGui:draw_list_add_bezier_quadratic(
	draw_list,
	p1_x,
	p1_y,
	p2_x,
...
-- @param integer num_segmentsIn Optional
-- @param number thicknessIn Optional
function ImGui:draw_list_add_ellipse(
	draw_list,
	center_x,
	center_y,
	radius_x,
	...
	local number = number or nil
	local integer = integer or nil
	return r.ImGui_DrawList_AddEllipse(
		draw_list,
		center_x,
		center_y,
		radius_x,
...
-- @param number rotIn Optional
-- @param integer num_segmentsIn Optional
function ImGui:draw_list_add_ellipse_filled(
	draw_list,
	center_x,
	center_y,
	radius_x,
	...
	local number = number or nil
	local integer = integer or nil
	return r.ImGui_DrawList_AddEllipseFilled(
		draw_list,
		center_x,
		center_y,
		radius_x,
...
function ImGui:draw_list_add_image(
	draw_list,
	image,
	p_min_x,
	p_min_y,
	...
	local number = number or nil
	local integer = integer or nil
	return r.ImGui_DrawList_AddImage(
		draw_list,
		image,
		p_min_x,
		p_min_y,
...
-- @param integer col_rgbaIn Optional
function ImGui:draw_list_add_image_quad(
	draw_list,
	image,
	p1_x,
	p1_y,
	...
	local number = number or nil
	local integer = integer or nil
	return r.ImGui_DrawList_AddImageQuad(
		draw_list,
		image,
		p1_x,
		p1_y,
...
-- @param integer flagsIn Optional
function ImGui:draw_list_add_image_rounded(
	draw_list,
	image,
	p_min_x,
	p_min_y,
	...
	local integer = integer or nil
	return r.ImGui_DrawList_AddImageRounded(
		draw_list,
		image,
		p_min_x,
		p_min_y,
...
-- @param a_max number
-- @param integer num_segmentsIn Optional
function ImGui:draw_list_path_elliptical_arc_to(
	draw_list,
	center_x,
	center_y,
	radius_x,
	...
	local integer = integer or nil
	return r.ImGui_DrawList_PathEllipticalArcTo(
		draw_list,
		center_x,
		center_y,
		radius_x,
