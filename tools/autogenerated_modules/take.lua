...
function Take:get_set_info_string(parm_name, string_need_big, set_new_value)
	local ret_val, string_need_big =
		r.GetSetMediaItemTakeInfo_String(self.pointer, parm_name, string_need_big, set_new_value)
	if ret_val then
...
function Take:midi_get_text_sysex_evt(textsyxevt_idx, boolean, boolean, number, integer, string)
	...
	local ret_val, boolean, boolean, number, integer, string =
		r.MIDI_GetTextSysexEvt(self.pointer, textsyxevt_idx, boolean, boolean, number, integer, string)
	if ret_val then
