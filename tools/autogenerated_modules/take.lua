...
function Take:midi_get_cc(cc_idx)
    local ret_val, selected, muted, ppq_pos, chanmsg, chan, msg2, msg3 = r.MIDI_GetCC(self.pointer, cc_idx)
    if ret_val then
        return selected, muted, ppq_pos, chanmsg, chan, msg2, msg3
    else
        return nil
    end
end
...
-- @param msg3 number
-- @return boolean
function Take:midi_insert_cc(selected, muted, ppq_pos, chanmsg, chan, msg2, msg3)
