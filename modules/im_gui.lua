...
function ImGui:combo(label, current_item, items, popup_max_height_in_items_in)
	local retval, current_item_, items_ =
		r.ImGui_Combo(self.ctx, label, current_item, items, popup_max_height_in_items_in)
	if retval then
...
function ImGui:drag_double(label, v, v_speed_in, v_min_in, v_max_in, format_in, flags)
	local retval, v_ = r.ImGui_DragDouble(self.ctx, label, v, v_speed_in, v_min_in, v_max_in, format_in, flags)
	if retval then
		return v_
	end
end
...
function ImGui:drag_double2(label, v1, v2, v_speed_in, v_min_in, v_max_in, format_in, flags)
	local retval, v1_, v2_ =
		r.ImGui_DragDouble2(self.ctx, label, v1, v2, v_speed_in, v_min_in, v_max_in, format_in, flags)
	if retval then
		return v1_, v2_
	end
end
...
function ImGui:drag_double3(label, v1, v2, v3, v_speed_in, v_min_in, v_max_in, format_in, flags)
	local retval, v1_, v2_, v3_ =
		r.ImGui_DragDouble3(self.ctx, label, v1, v2, v3, v_speed_in, v_min_in, v_max_in, format_in, flags)
	if retval then
		return v1_, v2_, v3_
	end
end
...
function ImGui:drag_double4(label, v1, v2, v3, v4, v_speed_in, v_min_in, v_max_in, format_in, flags)
	local retval, v1_, v2_, v3_, v4_ =
		r.ImGui_DragDouble4(self.ctx, label, v1, v2, v3, v4, v_speed_in, v_min_in, v_max_in, format_in, flags)
	if retval then
...
function ImGui:drag_double_n(label, values, ctx, speed_in, min_in, max_in, format_in, flags)
	return r.ImGui_DragDoubleN(self.ctx, label, values, ctx, speed_in, min_in, max_in, format_in, flags)
end
...
function ImGui:drag_int3(label, v1, v2, v3, v_speed_in, v_min_in, v_max_in, format_in, flags)
	local retval, v1_, v2_, v3_ =
		r.ImGui_DragInt3(self.ctx, label, v1, v2, v3, v_speed_in, v_min_in, v_max_in, format_in, flags)
	if retval then
		return v1_, v2_, v3_
	end
end
...
function ImGui:drag_int4(label, v1, v2, v3, v4, v_speed_in, v_min_in, v_max_in, format_in, flags)
	local retval, v1_, v2_, v3_, v4_ =
		r.ImGui_DragInt4(self.ctx, label, v1, v2, v3, v4, v_speed_in, v_min_in, v_max_in, format_in, flags)
	if retval then
		return v1_, v2_, v3_, v4_
	end
end
...
---@param flags number
---@return number, number
function ImGui:drag_int_range2(
	label,
	v_current_min,
	v_current_max,
	v_speed_in,
	...
	local retval, v_current_min_, v_current_max_ = r.ImGui_DragIntRange2(
		self.ctx,
		label,
		v_current_min,
		v_current_max,
...
function ImGui:draw_list_add_bezier_cubic(
	p1_x,
	p1_y,
	p2_x,
	p2_y,
	...
	return r.ImGui_DrawList_AddBezierCubic(
		self.ctx,
		p1_x,
		p1_y,
		p2_x,
...
function ImGui:draw_list_add_bezier_quadratic(p1_x, p1_y, p2_x, p2_y, p3_x, p3_y, col_rgba, thickness, num_segments_in)
	return r.ImGui_DrawList_AddBezierQuadratic(
		self.ctx,
		p1_x,
		p1_y,
		p2_x,
...
function ImGui:draw_list_add_rect(p_min_x, p_min_y, p_max_x, p_max_y, col_rgba, rounding_in, flags, thickness_in)
	return r.ImGui_DrawList_AddRect(
		self.ctx,
		p_min_x,
		p_min_y,
		p_max_x,
...
function ImGui:draw_list_add_rect_filled_multi_color(
	p_min_x,
	p_min_y,
	p_max_x,
	p_max_y,
	...
	return r.ImGui_DrawList_AddRectFilledMultiColor(
		self.ctx,
		p_min_x,
		p_min_y,
		p_max_x,
...
function ImGui:draw_list_add_text_ex(
	font,
	retval,
	font_size,
	pos_x,
	...
	text,
	wrap_width_in,
	cpu_fine_clip_rect_x_in,
	cpu_fine_clip_rect_y_in,
	cpu_fine_clip_rect_w_in,
	cpu_fine_clip_rect_h_in
)
	return r.ImGui_DrawList_AddTextEx(
		self.ctx,
		font,
		retval,
		font_size,
...
function ImGui:draw_list_push_clip_rect(
	clip_rect_min_x,
	clip_rect_min_y,
	clip_rect_max_x,
	clip_rect_max_y,
	intersect_with_current_clip_rect_in
)
	return r.ImGui_DrawList_PushClipRect(
		self.ctx,
		clip_rect_min_x,
		clip_rect_min_y,
		clip_rect_max_x,
...
function ImGui:slider_angle(label, v_rad, v_degrees_min_in, v_degrees_max_in, format_in, flags)
	local retval, v_rad_ =
		r.ImGui_SliderAngle(self.ctx, label, v_rad, v_degrees_min_in, v_degrees_max_in, format_in, flags)
	if retval then
		return v_rad_
	end
end
...
function ImGui:slider_double4(label, v1, v2, v3, v4, v_min, v_max, format_in, flags)
	local retval, v1_, v2_, v3_, v4_ =
		r.ImGui_SliderDouble4(self.ctx, label, v1, v2, v3, v4, v_min, v_max, format_in, flags)
	if retval then
		return v1_, v2_, v3_, v4_
	end
end
...
function ImGui:slider_int4(label, v1, v2, v3, v4, v_min, v_max, format_in, flags)
	local retval, v1_, v2_, v3_, v4_ =
		r.ImGui_SliderInt4(self.ctx, label, v1, v2, v3, v4, v_min, v_max, format_in, flags)
	if retval then
		return v1_, v2_, v3_, v4_
	end
end
...
function ImGui:table_get_column_sort_specs(id)
	local retval, column_user_id, column_index, sort_order, sort_direction =
		r.ImGui_TableGetColumnSortSpecs(self.ctx, id)
	if retval then
